...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos
{
    public class OpenBrowserOnClick : MonoBehaviour
    {
        ...
        public void Open()
        {
            Debug.Log("i called open()");
            Debug.Log($"LaunchUri: Launching {"http://" + TCPTestClient.IP + ":5000"}");

#if WINDOWS_UWP
            UnityEngine.WSA.Application.InvokeOnUIThread(async () =>
            {
                //bool result = await global::Windows.System.Launcher.LaunchUriAsync(new System.Uri("http://www.google.com/"));
                bool result = await global::Windows.System.Launcher.LaunchUriAsync(new System.Uri("http://" + TCPTestClient.IP + ":5000"));
                if (!result)
                {
            ...
            Application.OpenURL("http://" + TCPTestClient.IP + ":5000");
#endif
        }
    }
}
